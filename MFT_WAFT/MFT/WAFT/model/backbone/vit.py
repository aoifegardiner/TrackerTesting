...
import sys
from MFT_WAFT.MFT.WAFT.model.backbone.patch_embed import PatchEmbed
from MFT_WAFT.MFT.WAFT.thirdparty.DepthAnythingV2.depth_anything_v2.dpt import DPTHead
