...
import sys
import os
from MFT_WAFT.MFT.WAFT.thirdparty.DepthAnythingV2.depth_anything_v2.dpt import DepthAnythingV2
...
class DepthAnythingFeature(nn.Module):
    def __init__(self, encoder='vits', pretrained=True):
        ...
        if pretrained:
            depth_anything.load_state_dict(torch.load(PROJECT_ROOT / "MFT_WAFT" / "MFT" / "WAFT" / "depth-anything-ckpts" / f"depth_anything_v2_{encoder}.pth", map_location='cpu'))
