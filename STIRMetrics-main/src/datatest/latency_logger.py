...
class LatencyLogger(metaclass=SingletonMeta):
    ...
    @staticmethod
    def append(sequence_name: Union[str, int], delta_time: float):
        r"""
    ...
    @staticmethod
    def export_latencies_to_json(filename: Union[str, int]):
        r"""
    ...
    @staticmethod
    def export_latency_stats_to_json(filename: Union[str, int], first_n_frames_to_skip: int):
        r"""
