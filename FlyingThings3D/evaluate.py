...
SEQ_DIR = Path("/public_datasets/FlyingThings3D/frames_cleanpass/TEST/A/0001/left")  # <-- change to your folder

# Optional GT flow folder for that sequence (can be None / not exist)
#GT_FLOW_DIR = Path("/public_datasets/FlyingThings3D/frames_cleanpass/TEST/A/0000/left")  # <-- change or set to None
GT_FLOW_DIR = None  
...
# Output
OUT_DIR = Path("./flyingthings3d_mft_outputs")
OUT_VIDEO_NAME = "roi_debug_3.mp4"
OUT_CSV_NAME = "roi_sigma_3.csv"
